...
_commander["default"].version('1.0.0').description('this is a simple JSON key value discriminator.').option('-d , --dir <type>', 'directory folder name (required)').option('-f ,--first <type>', 'first json name - main file (required)').option('-s ,--second <type>', 'second json name - compare file (required)').action(function (options) {
